...
class VibrateWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomCardWidget(
      child: CustomListTileWidget(
        ...
        title: SettingsTitleWidget(text: DialogueService.vibrateTitleText.tr),
        subtitle: SettingsSubtitleWidget(text: DialogueService.vibrateSubtitleText.tr),
        trailing: CustomSwitchWidget(onChanged: userProvider.toggleVibrate, value: userProvider.getUserVibrate()),
      ),
    );
  }
}
