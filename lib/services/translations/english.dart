...
class EnglishTranslation {
  static Map<String, String> getEnglishTranslation() {
    return {
      ...
      // game - ongoing
      DialogueService.yourGameText: 'Your game with',
      DialogueService.otherPlayersGameText: '\'s game with you',
      DialogueService.oneOtherPlayerText: ' one AI player',
      DialogueService.twoOtherPlayerText: ' two AI players',
      DialogueService.threeOtherPlayerText: ' three AI players',
